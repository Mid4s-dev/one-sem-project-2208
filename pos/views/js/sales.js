      	...
      	success:function(answer){
	          ...
	          '<div class="col-xs-3 enterPrice" style="padding-left:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<span class="input-group-addon"><i class="text-success">Ksh</i></span>'+
		 ...
		 $(this).parent().parent().parent().children('.paymentMethodBoxes').html(
		 	...
		 	'<div class="col-xs-6" style="padding-left:0px">'+
                ...
                '<div class="input-group">'+
                  ...
                  '<input type="phone" class="form-control" id="stkpush" placeholder="enter customer phone number"  required>'+
                       
                  '<span><button type="stkpush" class="btn btn-primary pull-right">stk push</button><i class=""></i></span>'+
